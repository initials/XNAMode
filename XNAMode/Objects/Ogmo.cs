...
namespace OgmoXNADemo.Objects
{
    class Ogmo : GameObject
    {
        ...
        void Ogmo_Die(object sender, EventArgs e)
        {
        ...
        {
            foreach (GameObject gameObject in this.Level.Objects)
            {
        ...
        private void HandleCollisions()
        {
            ...
            for (int y = topTile; y <= bottomTile; ++y)
            {
                for (int x = leftTile; x <= rightTile; ++x)
                {
                    ...
                    bool collision = Level.GetCollision(x, y);
                    if (collision)
                    {
                        ...
                        if (depth != Vector2.Zero)
                        {
                            ...
                            else if (collision) // Ignore platforms.
                            {
