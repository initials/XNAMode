...
namespace Revvolvver
{
    ...
    public class MenuState : FlxState
    {
        ...
        private const string SndHit = "Revvolvver/menu_hit";
        private const string SndHit2 = "Revvolvver/menu_hit_2";
        ...
        override public void update()
        {
            ...
            if (!_ok && ((_t1.x == t1m) || (_t2.x == t2m)))
            {
                ...
                //flixel button
                this.add((new FlxSprite(t1m + 1, FlxG.height / 4 + 53)).createGraphic(106, 19, new Color(0x13, 0x1c, 0x1b)));
                b = new FlxButton(t1m + 2, FlxG.height / 4 + 54, onFlixel);
                ...
                //danny B button
                this.add((new FlxSprite(t1m + 1, FlxG.height / 4 + 75)).createGraphic(106, 19, new Color(0x13, 0x1c, 0x1b)));
                b = new FlxButton(t1m + 2, FlxG.height / 4 + 76, onDanny);
                b.loadGraphic((new FlxSprite()).createGraphic(104, 15, new Color(0x3a, 0x5c, 0x39)), (new FlxSprite()).createGraphic(104, 15, new Color(0x72, 0x99, 0x54)));
                ...
                //play button
                this.add((new FlxSprite(t1m + 1, FlxG.height / 4 + 137)).createGraphic(106, 19, new Color(0x13, 0x1c, 0x1b)));
                //#if WINDOWS
                ...
                //#endif
                t1 = new FlxText(t1m, FlxG.height - 30, 110, "PRESS X+C TO PLAY.");
                t1.color = new Color(0x72, 0x99, 0x54);
                t1.alignment = FlxJustification.Center;
                add(t1);
